...
function Login() {
    return ( 
        <>
            <header>
                <nav className="bg-[#18386B] border-[#18386B] px-4 lg:px-6 py-2.5 ">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="https://www.unach.mx/" className="flex items-center">
                    <img src={logo} className="mx-auto h-[90px] w-auto" alt="Unach Logo" />
                    </a>
                </div>
            ...
            <footer className="bg-[#18386B]  mt-10">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 b-0">
            <div className="sm:flex sm:items-center sm:justify-between">
            <a href="https://www.unach.mx/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                <img src={logo} className="mx-auto h-[90px] w-auto" alt="Unach Logo" />
            </a>    
    

            <div className="px-4 py-6 bg-[#18386B]  md:flex md:items-center md:justify-between">
        <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            <a href="https://www.facebook.com/comunicaunach/?locale=es_LA" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://twitter.com/unach" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
